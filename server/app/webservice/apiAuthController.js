...
class apiAuthController {
    ...
    async register(req, res) {
        try {
            ...
            const imagePath = req.file ? req.file.path : 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6PWiT4jbOgFjpAy0ROofuZ4PS8AzvDqqlDw&s'; // Provide

            const salt = bcrypt.genSaltSync(10);
            const hashedPassword = await bcrypt.hash(req.body.password, salt);
            const userData = {
                ...req.body, password: hashedPassword, profile_pic: imagePath
            };
